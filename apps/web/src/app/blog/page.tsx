...
// ✅ VERY IMPORTANT (prevents build execution issues)
...
export default async function BlogHomePage() {
  ...
  try {
    // ✅ SAFE GUARD (stops Supabase crash during build)
    if (
      !process.env.NEXT_PUBLIC_SUPABASE_URL ||
      !process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY
    ) {
      console.warn("⚠️ Skipping blog fetch during build")
      return (
    ...
    <>
      ...
      <section className="bg-white border-b">
        <div className="container-custom max-w-6xl py-16 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Practical guides, industry trends, and expert advice to accelerate
            your AI journey.
          </p>
      ...
      {featuredBlog && (
        <section className="container-custom max-w-6xl py-12">
          <Link
            href={`/blog/${featuredBlog.category_slug}/${featuredBlog.slug}`}
            className="block group"
          >
            <div className="grid md:grid-cols-2 bg-white rounded-xl overflow-hidden shadow hover:shadow-lg transition">
              ...
              <div className="p-8 flex flex-col justify-center">
                ...
                <h2 className="text-3xl font-bold mb-4 group-hover:text-blue-600 transition">
                  {featuredBlog.title}
                </h2>
